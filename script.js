  ...
  categories.forEach(category => {
    ...
    coursesForCategory.forEach(course => {
      const truncatedDescription =
        course.description.length > 23 ? course.description.substring(0, 23) + '...' : course.description;

      htmlString += `<div class="card mx-3" style="width: 18rem;">
        ...
        <div class="row no-gutters">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <p class="card-text"><small class="text-muted">Categories: ${course.categories.join(
                      ', ',
                    )}</small></p>
                    ${
                      course.author === username
                        ? `<button class="btn btn-outline-secondary" onclick="editCourseModal(${course.id})">Edit</button>`
                        : ''
                    }
